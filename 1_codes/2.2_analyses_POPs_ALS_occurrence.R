...
results_POPs_ALS_occurrence <- 
  list(main = list(main_results = main_results, 
                   ...
                   model2_gam_sensi_lipid = model2_gam_sensi_lipid, 
                   model2_gam_sensi_diabetes = model2_gam_sensi_diabetes, 
                   model2_gam_sensi_diabetes_chol = model2_gam_sensi_diabetes_chol, 
...
rm(main_results, covar, results_quart, model1_gam, model2_gam, 
   ...
   model2_gam_sensi_lipid, 
   model2_gam_sensi_diabetes, 
   model2_gam_sensi_diabetes_chol, 
   plot_quart_sensi_not_summed, 
