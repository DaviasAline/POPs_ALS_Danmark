...
## Additional analysis 5 - superlearner

### Test 1 a : method AUC, many algorithms, no pre screening, default hyperparameters

```{r}
summary(results_proteomic_ALS_occurrence_SL$sl_fit_CV_1_a)$Table |>
  as.data.frame() |>
  flextable() |> 
...
#### SL.glmnet
```{r}
summary(results_proteomic_ALS_occurrence_SL$sl_fit_CV_glmnet)$Table |>
  as.data.frame() |>
  flextable() |> 
  colformat_double(digits = 2) |>
  font(fontname = "Calibri", part = "all") |> 
...
plot(results_proteomic_ALS_occurrence_SL$sl_fit_CV_glmnet) + 
  theme_minimal() + 
...
#### SL.ranger 
```{r}
summary(results_proteomic_ALS_occurrence_SL$sl_fit_CV_ranger)$Table |>
  as.data.frame() |>
  flextable() |> 
  colformat_double(digits = 2) |>
  font(fontname = "Calibri", part = "all") |> 
...
plot(results_proteomic_ALS_occurrence_SL$sl_fit_CV_ranger) + 
  theme_minimal() + 
...
#### SL.xgboost
```{r}
summary(results_proteomic_ALS_occurrence_SL$sl_fit_CV_xgboost)$Table |>
  as.data.frame() |>
  flextable() |> 
  colformat_double(digits = 2) |>
  font(fontname = "Calibri", part = "all") |> 
...
plot(results_proteomic_ALS_occurrence_SL$sl_fit_CV_xgboost) + 
  theme_minimal() + 
...
#### SL.ksvm
```{r}
summary(results_proteomic_ALS_occurrence_SL$sl_fit_CV_ksvm)$Table |>
  as.data.frame() |>
  flextable() |> 
  colformat_double(digits = 2) |>
  font(fontname = "Calibri", part = "all") |> 
...
plot(results_proteomic_ALS_occurrence_SL$sl_fit_CV_ksvm) + 
  theme_minimal() + 
...
#### SL.earth
```{r}
summary(results_proteomic_ALS_occurrence_SL$sl_fit_CV_earth)$Table |>
  as.data.frame() |>
  flextable() |> 
  colformat_double(digits = 2) |>
  font(fontname = "Calibri", part = "all") |> 
...
plot(results_proteomic_ALS_occurrence_SL$sl_fit_CV_earth) + 
  theme_minimal() + 
...
```{r}
summary(results_proteomic_ALS_occurrence_SL$sl_fit_CV_1_b_opt_20)$Table |>
  as.data.frame() |>
  flextable() |> 
  colformat_double(digits = 2) |>
  font(fontname = "Calibri", part = "all") |> 
...
plot(results_proteomic_ALS_occurrence_SL$sl_fit_CV_1_b_opt_20) + 
  theme_minimal() + 
...
```{r}
summary(results_proteomic_ALS_occurrence_SL$sl_fit_CV_1_b_opt_10)$Table |>
  as.data.frame() |>
  flextable() |> 
  colformat_double(digits = 2) |>
  font(fontname = "Calibri", part = "all") |> 
...
plot(results_proteomic_ALS_occurrence_SL$sl_fit_CV_1_b_opt_10) + 
  theme_minimal() + 
...
```{r}
summary(results_proteomic_ALS_occurrence_SL$sl_fit_CV_1_c_opt_20)$Table |>
  as.data.frame() |>
  flextable() |> 
  colformat_double(digits = 2) |>
  font(fontname = "Calibri", part = "all") |> 
...
plot(results_proteomic_ALS_occurrence_SL$sl_fit_CV_1_c_opt_20) + 
  theme_minimal() + 
...
```{r}
summary(results_proteomic_ALS_occurrence_SL$sl_fit_CV_1_c_opt_10)$Table |>
  as.data.frame() |>
  flextable() |> 
  colformat_double(digits = 2) |>
  font(fontname = "Calibri", part = "all") |> 
...
plot(results_proteomic_ALS_occurrence_SL$sl_fit_CV_1_c_opt_10) + 
  theme_minimal() + 
...
all_weights <- lapply(results_proteomic_ALS_occurrence_SL$sl_fit_CV_1_c_opt_10$AllSL, function(x) x$coef)
weights_matrix <- do.call(rbind, all_weights)
colnames(weights_matrix) <- results_proteomic_ALS_occurrence_SL$sl_fit_CV_1_c_opt_10$libraryNames
...
leek_results_list <- lapply(results_proteomic_ALS_occurrence_SL$sl_fit_CV_1_c_opt_10$AllSL, function(fold_fit) {
...
glm_results_list <- lapply(results_proteomic_ALS_occurrence_SL$sl_fit_CV_1_c_opt_10$AllSL, function(fold_fit) {
