...
#### Continuous coding (standardized) - raw analysis not adjusted on cohort

```{r}
#| echo: false
#| message: false
#| warning: false
results_POPs_ALS_survival$finnish$POPs_sd_ALS_table_finnish_raw |>
  set_table_properties(width = 1, layout = "autofit", align = "left")
```
...
#| message: false
#| warning: false
results_POPs_ALS_survival$finnish$POPs_sd_ALS_figure_finnish_raw
```

#### Quartiles - raw analysis not adjusted on cohort
...
#| warning: false
#| column: screen-inset-right
results_POPs_ALS_survival$finnish$POPs_quart_ALS_table_finnish_raw |>
  set_table_properties(width = 1, layout = "autofit", align = "left")
```
...
#| message: false
#| warning: false
results_POPs_ALS_survival$finnish$POPs_quart_ALS_figure_finnish_raw
```

#### Continuous coding (standardized) - meta-analaysis
...
#### Quartiles - meta-analaysis

data not shown (instable)
...
The aim of this sensitivity analysis is to investigate if differences observed between the Danish and Finnish cohorts are due to differences in duration of follow-up and age at baseline We re-ran the models by selecting the Finnish cases with follow-up and age at baseline similar to the Danish cases

4 cohorts (EPIC/FMC/FMCF/MFH)
...
2 cohorts (Danish/Finnish)

```{r, fig.height=12, fig.width=12}
#| echo: false
#| message: false
#| warning: false
print(results_POPs_ALS_survival$sensi1$plot_justif_2cat)
```

Distribution of follow up and age at baseline among the cases within the boxes

```{r}
#| echo: false
#| message: false
#| warning: false
results_POPs_ALS_survival$sensi2$tbl_distrib_among_green_box |>
  as_flex_table() |>
  flextable::font(fontname = "Calibri", part = "all") |> 
  fontsize(size = 10, part = "all") |>
  padding(padding.top = 0, padding.bottom = 0, part = "all") |>
...
results_POPs_ALS_survival$sensi2$tbl_distrib_among_purple_box |>
  as_flex_table() |>
  flextable::font(fontname = "Calibri", part = "all") |> 
  fontsize(size = 10, part = "all") |>
  padding(padding.top = 0, padding.bottom = 0, part = "all") |>
...
results_POPs_ALS_survival$sensi2$tbl_distrib_among_orange_box |>
  as_flex_table() |>
  flextable::font(fontname = "Calibri", part = "all") |> 
  fontsize(size = 10, part = "all") |>
  padding(padding.top = 0, padding.bottom = 0, part = "all") |>
...
#| message: false
#| warning: false
corrplot(results_POPs_ALS_survival$sensi1$cor_test_sensi1, 
         method = 'color', 
         type = "lower", 
         tl.col = 'black', 
         tl.srt = 45, 
...
results not adjusted on the cohort, adjusted for sex, diagnosis age, smoking status, bmi and marital_status
...
results adjusted on the cohort (4 categories), adjusted for sex, diagnosis age, smoking status, bmi and marital_status These resuts are not trustful because sample size of MFH is too small (n=11)
...
results adjusted on the cohort (2 categories danish or finnish), adjusted for sex, diagnosis age, smoking status, bmi and marital_status
...
Correlation among standardized POPs among Danish ALS cases
...
Results of sensivitity analysis 1 may be driven by the Danish cases. Here, we ran adjusted and stratified analyses depending on effects of baseline age, follow-up duration just among the Finnish population All models are adjusted for sex, diagnosis age, smoking status, bmi and marital_status
...
#| warning: false
#| column: screen-inset-right
results_POPs_ALS_survival$sensi2$POPs_sd_ALS_figure_sensi2_finnish_orange 
results_POPs_ALS_survival$sensi2$POPs_sd_ALS_figure_sensi2_finnish_purple
results_POPs_ALS_survival$sensi2$POPs_sd_ALS_figure_sensi2_finnish_green
```

## Sensitivity analyses 3

Here, we tried baseline age and follow-up duration as interaction terms (continuous and categorical) just among the Finnish cases All models are adjusted for sex, diagnosis age, smoking status, bmi and marital_status
...
#| message: false
#| warning: false
results_POPs_ALS_survival$sensi3$POPs_sd_ALS_table_sensi3_baseline_age |>
  set_table_properties(width = 1, layout = "autofit", align = "left")
```
...
#| message: false
#| warning: false
results_POPs_ALS_survival$sensi3$POPs_sd_ALS_table_sensi3_follow_up |>
  set_table_properties(width = 1, layout = "autofit", align = "left")
```

### both baseline age and follow up duration

```{r}
#| echo: false
#| message: false
#| warning: false
results_POPs_ALS_survival$sensi3$POPs_sd_ALS_table_sensi3_baseline_age_follow_up |>
  set_table_properties(width = 1, layout = "autofit", align = "left")
```

## Sensitivity analyses 4

effects of survival duration among the Danish population

```{r, fig.height=12, fig.width=12}
#| echo: false
#| message: false
#| warning: false
results_POPs_ALS_survival$sensi4$plot_justif_sensi4
```
...
#| message: false
#| warning: false
results_POPs_ALS_survival$sensi4$POPs_sd_ALS_figure_sensi4_danish
```
...
#| message: false
#| warning: false
plot(results_POPs_ALS_survival$sensi5$sensi5_lasso_sd_danish)  
```
...
#| message: false
#| warning: false
plot(results_POPs_ALS_survival$sensi5$sensi5_ridge_sd_danish)  
```
...
#| message: false
#| warning: false
plot(results_POPs_ALS_survival$sensi5$sensi5_elastic_net_sd_danish)
```
...
#| message: false
#| warning: false
coef(results_POPs_ALS_survival$sensi5$sensi5_lasso_sd_danish, s = "lambda.min")  
```
...
#| message: false
#| warning: false
coef(results_POPs_ALS_survival$sensi5$sensi5_ridge_sd_danish, s = "lambda.min")  
```
...
#| message: false
#| warning: false
coef(results_POPs_ALS_survival$sensi5$sensi5_elastic_net_sd_danish, s = "lambda.min")
```
...
#| message: false
#| warning: false
coef(results_POPs_ALS_survival$sensi5$sensi5_lasso_sd_danish, s = "lambda.1se")  
```
...
#| message: false
#| warning: false
coef(results_POPs_ALS_survival$sensi5$sensi5_ridge_sd_danish, s = "lambda.1se")  
```
...
#| message: false
#| warning: false
coef(results_POPs_ALS_survival$sensi5$sensi5_elastic_net_sd_danish, s = "lambda.1se")
```
...
results_POPs_ALS_survival$sensi5$POPs_sd_ALS_table_sensi5_danish
```
...
#| message: false
#| warning: false
results_POPs_ALS_survival$sensi5$POPs_quart_ALS_figure_sensi5_danish
results_POPs_ALS_survival$sensi5$POPs_quart_ALS_table_sensi5_danish
```
...
#| message: false
#| warning: false
results_POPs_ALS_survival$sensi5$POPs_sd_ALS_figure_sensi5_ERS_danish
results_POPs_ALS_survival$sensi5$POPs_sd_ALS_table_sensi5_ERS_danish
```
...
#| message: false
#| warning: false
results_POPs_ALS_survival$sensi5$POPs_quart_ALS_figure_sensi5_ERS_danish
results_POPs_ALS_survival$sensi5$POPs_quart_ALS_table_sensi5_ERS_danish
```
...
#| message: false
#| warning: false
coef(results_POPs_ALS_survival$sensi6$sensi6_lasso_sd_danish, s = "lambda.min")  
```
...
#| message: false
#| warning: false
coef(results_POPs_ALS_survival$sensi6$sensi6_elastic_net_sd_danish, s = "lambda.min")
```
...
#| message: false
#| warning: false
results_POPs_ALS_survival$sensi6$POPs_sd_ALS_figure_sensi6_danish
results_POPs_ALS_survival$sensi6$POPs_sd_ALS_table_sensi6_danish
```
...
#| message: false
#| warning: false
results_POPs_ALS_survival$sensi6$POPs_quart_ALS_figure_sensi6_danish
results_POPs_ALS_survival$sensi6$POPs_quart_ALS_table_sensi6_danish
```
...
#| message: false
#| warning: false
results_POPs_ALS_survival$sensi6$POPs_sd_ALS_figure_sensi6_ERS_danish
results_POPs_ALS_survival$sensi6$POPs_sd_ALS_table_sensi6_ERS_danish
```
...
#| message: false
#| warning: false
results_POPs_ALS_survival$sensi6$POPs_quart_ALS_figure_sensi6_ERS_danish
results_POPs_ALS_survival$sensi6$POPs_quart_ALS_table_sensi6_ERS_danish
```
...
#| message: false
#| warning: false
results_POPs_ALS_survival$sensi7$sensi7_figure
```
...
#| message: false
#| warning: false
results_POPs_ALS_survival$sensi7$sensi7_table
```
...
#| message: false
#| warning: false
results_proteomic_ALS_occurrence$covar
```
...
#| message: false
#| warning: false
results_proteomic_ALS_occurrence$proteomic_sd_ALS_table

wrap_plots(results_proteomic_ALS_occurrence$proteomic_sd_ALS_base_figure, 
           results_proteomic_ALS_occurrence$proteomic_sd_ALS_adjusted_figure, 
           ncol = 1)
```
...
#| message: false
#| warning: false
results_proteomic_ALS_occurrence$proteomic_quart_ALS_table
```
...
#| warning: false
#| column: screen-inset-right
wrap_plots(results_proteomic_ALS_occurrence$plot_base_gam, ncol = 4)
wrap_plots(results_proteomic_ALS_occurrence$plot_adjusted_gam, ncol = 4)
```
...
wrap_plots(results_proteomic_ALS_survival$proteomic_sd_ALS_base_figure, 
...
#| warning: false
#| column: screen-inset-right
wrap_plots(results_proteomic_ALS_survival$plot_base_gam, ncol = 4)
wrap_plots(results_proteomic_ALS_survival$plot_adjusted_gam, ncol = 4)
```
