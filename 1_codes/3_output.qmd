...
#| message: false
#| warning: false
plot(results_POPs_ALS_survival$sensi5$model_lasso_sd_danish)  
```
...
#| message: false
#| warning: false
plot(results_POPs_ALS_survival$sensi5$model_ridge_sd_danish)  
```
...
#| message: false
#| warning: false
plot(results_POPs_ALS_survival$sensi5$model_elastic_net_sd_danish)
```
...
#| message: false
#| warning: false
coef(results_POPs_ALS_survival$sensi5$model_lasso_sd_danish, s = "lambda.min")  
```
...
#| message: false
#| warning: false
coef(results_POPs_ALS_survival$sensi5$model_ridge_sd_danish, s = "lambda.min")  
```
...
#| message: false
#| warning: false
coef(results_POPs_ALS_survival$sensi5$model_elastic_net_sd_danish, s = "lambda.min")
```
...
#| message: false
#| warning: false
coef(results_POPs_ALS_survival$sensi5$model_lasso_sd_danish, s = "lambda.1se")  
```
...
#| message: false
#| warning: false
coef(results_POPs_ALS_survival$sensi5$model_ridge_sd_danish, s = "lambda.1se")  
```
...
#| message: false
#| warning: false
coef(results_POPs_ALS_survival$sensi5$model_elastic_net_sd_danish, s = "lambda.1se")
```
