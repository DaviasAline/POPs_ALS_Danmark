...
#### Quartile models
##### Main analysis
In the copollutant models, the pollutant of interest is quartile while the others are continuous
...
In the copollutant model, all the pollutants are quartiles
```{r fig.height=9, fig.width=9}
#| echo: false
#| message: false
#| warning: false
...
#| message: false
#| warning: false
results_POPs_ALS_occurrence$main$plot_quart_bis_bis
```
...
#| message: false
#| warning: false
results_POPs_ALS_survival$finnish$covar_ALS_table_finnish  |> kable("html")
```
