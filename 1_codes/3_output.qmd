...
#| message: false
#| warning: false
results_proteomic_ALS_occurrence$additional_analysis_5$test_1$summary_sl_fit_CV_1
results_proteomic_ALS_occurrence$additional_analysis_5$test_1$plot_roc_sl_fit_CV_1
plot(results_proteomic_ALS_occurrence$additional_analysis_5$test_1$plot_roc_sl_fit_CV_1)

print("Protéines sélectionnées par Leekasso :")
print(results_proteomic_ALS_occurrence$additional_analysis_5$test_1$genes_selected_1)

# Magnitude of the coefficients 
results_proteomic_ALS_occurrence$additional_analysis_5$test_1$leek_coeffs_1

# Correlation matrix of the selected proteins
corrplot(results_proteomic_ALS_occurrence$additional_analysis_5$test_1$cor_matrix_1, method = "color", type = "upper", tl.col = "black", tl.srt = 45)
```
...
#| message: false
#| warning: false
results_proteomic_ALS_occurrence$additional_analysis_5$test_2$summary_sl_fit_CV_2
results_proteomic_ALS_occurrence$additional_analysis_5$test_2$plot_roc_sl_fit_CV_2
plot(results_proteomic_ALS_occurrence$additional_analysis_5$test_2$plot_roc_sl_fit_CV_2)

print("Protéines sélectionnées par Leekasso :")
print(results_proteomic_ALS_occurrence$additional_analysis_5$test_2$genes_selected_2)

# Magnitude of the coefficients 
results_proteomic_ALS_occurrence$additional_analysis_5$test_2$leek_coeffs_2

# Correlation matrix of the selected proteins
corrplot(results_proteomic_ALS_occurrence$additional_analysis_5$test_2$cor_matrix_2, method = "color", type = "upper", tl.col = "black", tl.srt = 45)
```
...
#| message: false
#| warning: false
results_proteomic_ALS_occurrence$additional_analysis_5$test_3$summary_sl_fit_CV_3
results_proteomic_ALS_occurrence$additional_analysis_5$test_3$plot_roc_sl_fit_CV_3
plot(results_proteomic_ALS_occurrence$additional_analysis_5$test_3$plot_roc_sl_fit_CV_3)

print("Protéines sélectionnées par Leekasso :")
print(results_proteomic_ALS_occurrence$additional_analysis_5$test_3$genes_selected_3)

# Magnitude of the coefficients 
results_proteomic_ALS_occurrence$additional_analysis_5$test_3$leek_coeffs_3

# Correlation matrix of the selected proteins
corrplot(results_proteomic_ALS_occurrence$additional_analysis_5$test_3$cor_matrix_3, method = "color", type = "upper", tl.col = "black", tl.srt = 45)
```
