...
wrap_plots(results_POPs_ALS_occurrence$main$plot_base_gam, nrow = 2)
```
...
#| warning: false
#| column: screen-inset-right
wrap_plots(results_POPs_ALS_occurrence$main$plot_adjusted_gam, nrow = 2)
```
...
#| warning: false
#| column: screen-inset-right
wrap_plots(results_POPs_ALS_occurrence$main$plot_copollutant_gam, nrow = 2)
```
