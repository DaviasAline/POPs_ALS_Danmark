...
# NEFL and ALS 
```{r}
wrap_plots(results_proteomic_ALS_occurrence$sensi_1$plot_base_gam_sensi_1$proteomic_neuro_explo_NEFL_sensi_1, 
           results_proteomic_ALS_occurrence$sensi_1$plot_adjusted_gam_sensi_1$proteomic_neuro_explo_NEFL_sensi_1)
```
...
#                 results_POPs_ALS_survival$main_analysis$plot_copollutant_cox_gam_danish$ΣDDT, 
#                 
...
#                 results_POPs_ALS_survival$main_analysis$plot_copollutant_cox_gam_danish$OCP_β_HCH, 
#                 
...
#                 results_POPs_ALS_survival$main_analysis$plot_copollutant_cox_gam_danish$Σchlordane, 
#                 
...
#                 results_POPs_ALS_survival$main_analysis$plot_copollutant_cox_gam_danish$ΣPBDE), 
#            ncol = 3)
...
#| message: false
#| warning: false
# wrap_plots(results_proteomic_ALS_occurrence$main$plot_base_gam, ncol = 3)
# wrap_plots(results_proteomic_ALS_occurrence$main$plot_adjusted_gam, ncol = 3)


wrap_plots(list(results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_immun_res_PSIP1,
results_proteomic_ALS_occurrence$main$plot_adjusted_gam$proteomic_immun_res_PSIP1,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_immun_res_PIK3AP1,
results_proteomic_ALS_occurrence$main$plot_adjusted_gam$proteomic_immun_res_PIK3AP1,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_immun_res_ICA1,
results_proteomic_ALS_occurrence$main$plot_adjusted_gam$proteomic_immun_res_ICA1,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_immun_res_DFFA,
results_proteomic_ALS_occurrence$main$plot_adjusted_gam$proteomic_immun_res_DFFA,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_neuro_explo_CD33,
results_proteomic_ALS_occurrence$main$plot_adjusted_gam$proteomic_neuro_explo_CD33,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_neuro_explo_NPM1,
results_proteomic_ALS_occurrence$main$plot_adjusted_gam$proteomic_neuro_explo_NPM1,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_neuro_explo_MAD1L1,
results_proteomic_ALS_occurrence$main$plot_adjusted_gam$proteomic_neuro_explo_MAD1L1,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_neuro_explo_AKT1S1,
results_proteomic_ALS_occurrence$main$plot_adjusted_gam$proteomic_neuro_explo_AKT1S1,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_neuro_explo_IL32,
results_proteomic_ALS_occurrence$main$plot_adjusted_gam$proteomic_neuro_explo_IL32,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_neuro_explo_NEFL,
results_proteomic_ALS_occurrence$main$plot_adjusted_gam$proteomic_neuro_explo_NEFL,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_metabolism_CLMP,
results_proteomic_ALS_occurrence$main$plot_adjusted_gam$proteomic_metabolism_CLMP,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_metabolism_NPTXR,
results_proteomic_ALS_occurrence$main$plot_adjusted_gam$proteomic_metabolism_NPTXR,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_metabolism_ANGPTL7,
results_proteomic_ALS_occurrence$main$plot_adjusted_gam$proteomic_metabolism_ANGPTL7,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_metabolism_GLRX,
results_proteomic_ALS_occurrence$main$plot_adjusted_gam$proteomic_metabolism_GLRX,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_metabolism_QDPR,
results_proteomic_ALS_occurrence$main$plot_adjusted_gam$proteomic_metabolism_QDPR,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_metabolism_APEX1,
results_proteomic_ALS_occurrence$main$plot_adjusted_gam$proteomic_metabolism_APEX1,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_metabolism_HDGF,
results_proteomic_ALS_occurrence$main$plot_adjusted_gam$proteomic_metabolism_HDGF,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_metabolism_LRP11,
results_proteomic_ALS_occurrence$main$plot_adjusted_gam$proteomic_metabolism_LRP11,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_metabolism_ARG1,
results_proteomic_ALS_occurrence$main$plot_adjusted_gam$proteomic_metabolism_ARG1,

wrap_elements(grid::nullGrob()),
results_proteomic_ALS_occurrence$main$plot_adjusted_gam$proteomic_immun_res_HNMT,

wrap_elements(grid::nullGrob()),
results_proteomic_ALS_occurrence$main$plot_adjusted_gam$proteomic_immun_res_SH2D1A,

wrap_elements(grid::nullGrob()),
results_proteomic_ALS_occurrence$main$plot_adjusted_gam$proteomic_metabolism_CD164,

wrap_elements(grid::nullGrob()),
results_proteomic_ALS_occurrence$main$plot_adjusted_gam$proteomic_metabolism_MCFD2),
...
#| message: false
#| warning: false
wrap_plots(results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_neuro_explo_NEFL,
           results_proteomic_ALS_occurrence$sensi_1$plot_base_gam_sensi_1$proteomic_neuro_explo_NEFL_sensi_1, 
           ncol = 2)
```
...
#| message: false
#| warning: false
wrap_plots(results_proteomic_ALS_occurrence$main$plot_adjusted_gam$proteomic_neuro_explo_NEFL,
           results_proteomic_ALS_occurrence$sensi_1$plot_adjusted_gam_sensi_1$proteomic_neuro_explo_NEFL_sensi_1, 
           ncol = 2)
```

## Sensitivity 2: Removing cases and their controls with follow-up \< 5 years

Data not shown because of merging sensi 1 and sensi 2
...
results_proteomic_ALS_occurrence$main$proteomic_sd_ALS_base_figure + labs(title = "Main analysis - Base model") + theme(legend.position = "none") + 
  results_proteomic_ALS_occurrence$sensi_2$proteomic_sd_ALS_base_figure_sensi_2 + labs(title = "Filtered to follow-up>5years - Base model") + theme(legend.position = "bottom") +
  plot_layout(ncol = 2)

results_proteomic_ALS_occurrence$main$proteomic_sd_ALS_adjusted_figure + labs(title = "Main analysis - Adjusted model") + theme(legend.position = "none") + 
  results_proteomic_ALS_occurrence$sensi_2$proteomic_sd_ALS_adjusted_figure_sensi_2 + labs(title = "Filtered to follow-up>5years - Adjusted model") + theme(legend.position = "bottom") +
  plot_layout(ncol = 2)
```
...
# Conditional logistic regressions (quartiles), matched on age at baseline and sex (further adjusted for smoking and body mass index)
results_proteomic_ALS_occurrence$sensi_2$proteomic_quart_ALS_table_sensi_2 |>
  set_table_properties(width = 1, layout = "autofit", align = "left")
```
...
### GAMs 
# Generalized additive models modeling proteins as smooth terms (thin plate splines), base models adjusted on sex and age at baseline. Adjusted models further account for smoking and body mass index
wrap_plots(list(results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_immun_res_PIK3AP1,
results_proteomic_ALS_occurrence$sensi_2$plot_base_gam_sensi_2$proteomic_immun_res_PIK3AP1,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_immun_res_ICA1,
results_proteomic_ALS_occurrence$sensi_2$plot_base_gam_sensi_2$proteomic_immun_res_ICA1,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_immun_res_DFFA,
results_proteomic_ALS_occurrence$sensi_2$plot_base_gam_sensi_2$proteomic_immun_res_DFFA,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_neuro_explo_NPM1,
results_proteomic_ALS_occurrence$sensi_2$plot_base_gam_sensi_2$proteomic_neuro_explo_NPM1,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_neuro_explo_MAD1L1 ,
results_proteomic_ALS_occurrence$sensi_2$plot_base_gam_sensi_2$proteomic_neuro_explo_MAD1L1,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_neuro_explo_AKT1S1 ,
results_proteomic_ALS_occurrence$sensi_2$plot_base_gam_sensi_2$proteomic_neuro_explo_AKT1S1,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_neuro_explo_IL32 ,
results_proteomic_ALS_occurrence$sensi_2$plot_base_gam_sensi_2$proteomic_neuro_explo_IL32,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_neuro_explo_NEFL ,
results_proteomic_ALS_occurrence$sensi_2$plot_base_gam_sensi_2$proteomic_neuro_explo_NEFL,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_metabolism_CLMP ,
results_proteomic_ALS_occurrence$sensi_2$plot_base_gam_sensi_2$proteomic_metabolism_CLMP,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_metabolism_NPTXR ,
results_proteomic_ALS_occurrence$sensi_2$plot_base_gam_sensi_2$proteomic_metabolism_NPTXR,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_metabolism_GLRX,
results_proteomic_ALS_occurrence$sensi_2$plot_base_gam_sensi_2$proteomic_metabolism_GLRX,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_metabolism_APEX1 ,
results_proteomic_ALS_occurrence$sensi_2$plot_base_gam_sensi_2$proteomic_metabolism_APEX1,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_metabolism_HDGF ,
results_proteomic_ALS_occurrence$sensi_2$plot_base_gam_sensi_2$proteomic_metabolism_HDGF,

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_metabolism_ARG1 ,
wrap_elements(grid::nullGrob()),

results_proteomic_ALS_occurrence$main$plot_base_gam$proteomic_immun_res_PSIP1,
wrap_elements(grid::nullGrob()),
...
wrap_elements(grid::nullGrob()),
results_proteomic_ALS_occurrence$sensi_2$plot_base_gam_sensi_2$proteomic_metabolism_ARG1,
wrap_elements(grid::nullGrob()),
results_proteomic_ALS_occurrence$sensi_2$plot_base_gam_sensi_2$proteomic_immun_res_DCTN1,
wrap_elements(grid::nullGrob()),
results_proteomic_ALS_occurrence$sensi_2$plot_base_gam_sensi_2$proteomic_neuro_explo_SRP14,
wrap_elements(grid::nullGrob()),
results_proteomic_ALS_occurrence$sensi_2$plot_base_gam_sensi_2$proteomic_metabolism_CLEC5A,
wrap_elements(grid::nullGrob()),
results_proteomic_ALS_occurrence$sensi_2$plot_base_gam_sensi_2$proteomic_metabolism_MCFD2,
wrap_elements(grid::nullGrob()),
results_proteomic_ALS_occurrence$sensi_2$plot_base_gam_sensi_2$proteomic_metabolism_PAG1), 
ncol = 2, nrow = 25)

```

## Sensitivity 1 + 2: Removing NEFL outlier + removing cases and their controls with follow_up \< 5 years
...
results_proteomic_ALS_occurrence$sensi_1_2$proteomic_sd_ALS_table_sensi_1_2 |>
  set_table_properties(width = 1, layout = "autofit", align = "left")
```
...
results_proteomic_ALS_occurrence$sensi_1$proteomic_sd_ALS_base_figure_sensi_1 + 
  ...
  results_proteomic_ALS_occurrence$sensi_1_2$proteomic_sd_ALS_base_figure_sensi_1_2 + 
...
results_proteomic_ALS_occurrence$sensi_1$proteomic_sd_ALS_adjusted_figure_sensi_1 + 
  labs(title = "NEFL outlier removed \n Adjusted model") + 
  theme(legend.position = "none") + 
  results_proteomic_ALS_occurrence$sensi_1_2$proteomic_sd_ALS_adjusted_figure_sensi_1_2 + 
  labs(title = "Filtered to follow-up>5years\n+ NEFL outlier excluded \n Adjusted model") + 
  theme(legend.position = "bottom") +
  plot_layout(ncol = 2)
```
...
results_proteomic_ALS_occurrence$sensi_1_2$proteomic_quart_ALS_table_sensi_1_2 |>
  set_table_properties(width = 1, layout = "autofit", align = "left")
```
...
#| column: screen-inset-right
wrap_plots(list(
results_proteomic_ALS_occurrence$sensi_1$plot_base_gam_sensi_1$proteomic_immun_res_PIK3AP1,
results_proteomic_ALS_occurrence$sensi_1_2$plot_base_gam_sensi_1_2$proteomic_immun_res_PIK3AP1,
results_proteomic_ALS_occurrence$sensi_1$plot_adjusted_gam_sensi_1$proteomic_immun_res_PIK3AP1, 
results_proteomic_ALS_occurrence$sensi_1_2$plot_adjusted_gam_sensi_1_2$proteomic_immun_res_PIK3AP1, 

results_proteomic_ALS_occurrence$sensi_1$plot_base_gam_sensi_1$proteomic_immun_res_ICA1,
results_proteomic_ALS_occurrence$sensi_1_2$plot_base_gam_sensi_1_2$proteomic_immun_res_ICA1,
results_proteomic_ALS_occurrence$sensi_1$plot_adjusted_gam_sensi_1$proteomic_immun_res_ICA1, 
results_proteomic_ALS_occurrence$sensi_1_2$plot_adjusted_gam_sensi_1_2$proteomic_immun_res_ICA1, 

results_proteomic_ALS_occurrence$sensi_1$plot_base_gam_sensi_1$proteomic_immun_res_DFFA,
results_proteomic_ALS_occurrence$sensi_1_2$plot_base_gam_sensi_1_2$proteomic_immun_res_DFFA,
results_proteomic_ALS_occurrence$sensi_1$plot_adjusted_gam_sensi_1$proteomic_immun_res_DFFA, 
results_proteomic_ALS_occurrence$sensi_1_2$plot_adjusted_gam_sensi_1_2$proteomic_immun_res_DFFA, 

results_proteomic_ALS_occurrence$sensi_1$plot_base_gam_sensi_1$proteomic_neuro_explo_NPM1,
results_proteomic_ALS_occurrence$sensi_1_2$plot_base_gam_sensi_1_2$proteomic_neuro_explo_NPM1,
results_proteomic_ALS_occurrence$sensi_1$plot_adjusted_gam_sensi_1$proteomic_neuro_explo_NPM1, 
results_proteomic_ALS_occurrence$sensi_1_2$plot_adjusted_gam_sensi_1_2$proteomic_neuro_explo_NPM1, 

results_proteomic_ALS_occurrence$sensi_1$plot_base_gam_sensi_1$proteomic_neuro_explo_IL32,
results_proteomic_ALS_occurrence$sensi_1_2$plot_base_gam_sensi_1_2$proteomic_neuro_explo_IL32,
results_proteomic_ALS_occurrence$sensi_1$plot_adjusted_gam_sensi_1$proteomic_neuro_explo_IL32, 
results_proteomic_ALS_occurrence$sensi_1_2$plot_adjusted_gam_sensi_1_2$proteomic_neuro_explo_IL32, 

results_proteomic_ALS_occurrence$sensi_1$plot_base_gam_sensi_1$proteomic_neuro_explo_NEFL_sensi_1,
results_proteomic_ALS_occurrence$sensi_1_2$plot_base_gam_sensi_1_2$proteomic_neuro_explo_NEFL_sensi_1_2,
results_proteomic_ALS_occurrence$sensi_1$plot_adjusted_gam_sensi_1$proteomic_neuro_explo_NEFL_sensi_1, 
results_proteomic_ALS_occurrence$sensi_1_2$plot_adjusted_gam_sensi_1_2$proteomic_neuro_explo_NEFL_sensi_1_2, 

results_proteomic_ALS_occurrence$sensi_1$plot_base_gam_sensi_1$proteomic_metabolism_CLMP,
results_proteomic_ALS_occurrence$sensi_1_2$plot_base_gam_sensi_1_2$proteomic_metabolism_CLMP,
results_proteomic_ALS_occurrence$sensi_1$plot_adjusted_gam_sensi_1$proteomic_metabolism_CLMP, 
results_proteomic_ALS_occurrence$sensi_1_2$plot_adjusted_gam_sensi_1_2$proteomic_metabolism_CLMP, 

results_proteomic_ALS_occurrence$sensi_1$plot_base_gam_sensi_1$proteomic_metabolism_NPTXR,
results_proteomic_ALS_occurrence$sensi_1_2$plot_base_gam_sensi_1_2$proteomic_metabolism_NPTXR,
results_proteomic_ALS_occurrence$sensi_1$plot_adjusted_gam_sensi_1$proteomic_metabolism_NPTXR, results_proteomic_ALS_occurrence$sensi_1_2$plot_adjusted_gam_sensi_1_2$proteomic_metabolism_NPTXR, 

results_proteomic_ALS_occurrence$sensi_1$plot_base_gam_sensi_1$proteomic_metabolism_GLRX,
results_proteomic_ALS_occurrence$sensi_1_2$plot_base_gam_sensi_1_2$proteomic_metabolism_GLRX,
results_proteomic_ALS_occurrence$sensi_1$plot_adjusted_gam_sensi_1$proteomic_metabolism_GLRX, 
results_proteomic_ALS_occurrence$sensi_1_2$plot_adjusted_gam_sensi_1_2$proteomic_metabolism_GLRX, 

results_proteomic_ALS_occurrence$sensi_1$plot_base_gam_sensi_1$proteomic_metabolism_APEX1,
results_proteomic_ALS_occurrence$sensi_1_2$plot_base_gam_sensi_1_2$proteomic_metabolism_APEX1,
results_proteomic_ALS_occurrence$sensi_1$plot_adjusted_gam_sensi_1$proteomic_metabolism_APEX1, 
results_proteomic_ALS_occurrence$sensi_1_2$plot_adjusted_gam_sensi_1_2$proteomic_metabolism_APEX1, 

results_proteomic_ALS_occurrence$sensi_1$plot_base_gam_sensi_1$proteomic_neuro_explo_MAD1L1,
results_proteomic_ALS_occurrence$sensi_1_2$plot_base_gam_sensi_1_2$proteomic_neuro_explo_MAD1L1,
results_proteomic_ALS_occurrence$sensi_1$plot_adjusted_gam_sensi_1$proteomic_neuro_explo_MAD1L1,
wrap_elements(grid::nullGrob()),

results_proteomic_ALS_occurrence$sensi_1$plot_base_gam_sensi_1$proteomic_neuro_explo_AKT1S1,
results_proteomic_ALS_occurrence$sensi_1_2$plot_base_gam_sensi_1_2$proteomic_neuro_explo_AKT1S1,
results_proteomic_ALS_occurrence$sensi_1$plot_adjusted_gam_sensi_1$proteomic_neuro_explo_AKT1S1, 
results_proteomic_ALS_occurrence$sensi_1_2$plot_adjusted_gam_sensi_1_2$proteomic_neuro_explo_AKT1S1, 

results_proteomic_ALS_occurrence$sensi_1$plot_base_gam_sensi_1$proteomic_metabolism_HDGF,
results_proteomic_ALS_occurrence$sensi_1_2$plot_base_gam_sensi_1_2$proteomic_metabolism_HDGF,
results_proteomic_ALS_occurrence$sensi_1$plot_adjusted_gam_sensi_1$proteomic_metabolism_HDGF, 
wrap_elements(grid::nullGrob()),

results_proteomic_ALS_occurrence$sensi_1$plot_base_gam_sensi_1$proteomic_metabolism_ARG1,
results_proteomic_ALS_occurrence$sensi_1_2$plot_base_gam_sensi_1_2$proteomic_metabolism_ARG1,
results_proteomic_ALS_occurrence$sensi_1$plot_adjusted_gam_sensi_1$proteomic_metabolism_ARG1, 
results_proteomic_ALS_occurrence$sensi_1_2$plot_adjusted_gam_sensi_1_2$proteomic_metabolism_ARG1, 

results_proteomic_ALS_occurrence$sensi_1$plot_base_gam_sensi_1$proteomic_immun_res_PSIP1,
wrap_elements(grid::nullGrob()),
results_proteomic_ALS_occurrence$sensi_1$plot_adjusted_gam_sensi_1$proteomic_immun_res_PSIP1, 
wrap_elements(grid::nullGrob()),

results_proteomic_ALS_occurrence$sensi_1$plot_base_gam_sensi_1$proteomic_neuro_explo_CD33,
wrap_elements(grid::nullGrob()),
results_proteomic_ALS_occurrence$sensi_1$plot_adjusted_gam_sensi_1$proteomic_neuro_explo_CD33, 
wrap_elements(grid::nullGrob()),

results_proteomic_ALS_occurrence$sensi_1$plot_base_gam_sensi_1$proteomic_metabolism_ANGPTL7,
wrap_elements(grid::nullGrob()),
results_proteomic_ALS_occurrence$sensi_1$plot_adjusted_gam_sensi_1$proteomic_metabolism_ANGPTL7, 
wrap_elements(grid::nullGrob()),

results_proteomic_ALS_occurrence$sensi_1$plot_base_gam_sensi_1$proteomic_metabolism_QDPR,
wrap_elements(grid::nullGrob()),
results_proteomic_ALS_occurrence$sensi_1$plot_adjusted_gam_sensi_1$proteomic_metabolism_QDPR,
wrap_elements(grid::nullGrob()),

results_proteomic_ALS_occurrence$sensi_1$plot_base_gam_sensi_1$proteomic_metabolism_LRP11,
wrap_elements(grid::nullGrob()),
results_proteomic_ALS_occurrence$sensi_1$plot_adjusted_gam_sensi_1$proteomic_metabolism_LRP11, 
wrap_elements(grid::nullGrob()),

wrap_elements(grid::nullGrob()),
results_proteomic_ALS_occurrence$sensi_1_2$plot_base_gam_sensi_1_2$proteomic_immun_res_DCTN1,
wrap_elements(grid::nullGrob()),
results_proteomic_ALS_occurrence$sensi_1_2$plot_adjusted_gam_sensi_1_2$proteomic_immun_res_DCTN1,

wrap_elements(grid::nullGrob()),
results_proteomic_ALS_occurrence$sensi_1_2$plot_base_gam_sensi_1_2$proteomic_neuro_explo_SRP14,
wrap_elements(grid::nullGrob()),
results_proteomic_ALS_occurrence$sensi_1_2$plot_adjusted_gam_sensi_1_2$proteomic_neuro_explo_SRP14,

wrap_elements(grid::nullGrob()),
results_proteomic_ALS_occurrence$sensi_1_2$plot_base_gam_sensi_1_2$proteomic_metabolism_CLEC5A,
wrap_elements(grid::nullGrob()),
results_proteomic_ALS_occurrence$sensi_1_2$plot_adjusted_gam_sensi_1_2$proteomic_metabolism_CLEC5A,

wrap_elements(grid::nullGrob()),
results_proteomic_ALS_occurrence$sensi_1_2$plot_base_gam_sensi_1_2$proteomic_metabolism_MCFD2,
results_proteomic_ALS_occurrence$sensi_1$plot_adjusted_gam_sensi_1$proteomic_metabolism_MCFD2, 
results_proteomic_ALS_occurrence$sensi_1_2$plot_adjusted_gam_sensi_1_2$proteomic_metabolism_MCFD2, 

wrap_elements(grid::nullGrob()),
results_proteomic_ALS_occurrence$sensi_1_2$plot_base_gam_sensi_1_2$proteomic_metabolism_PAG1, 
wrap_elements(grid::nullGrob()),
results_proteomic_ALS_occurrence$sensi_1_2$plot_adjusted_gam_sensi_1_2$proteomic_metabolism_PAG1, 

wrap_elements(grid::nullGrob()),
wrap_elements(grid::nullGrob()),
results_proteomic_ALS_occurrence$sensi_1$plot_adjusted_gam_sensi_1$proteomic_immun_res_HNMT,
wrap_elements(grid::nullGrob()),
  
wrap_elements(grid::nullGrob()),
wrap_elements(grid::nullGrob()),
results_proteomic_ALS_occurrence$sensi_1$plot_adjusted_gam_sensi_1$proteomic_immun_res_SH2D1A, 
wrap_elements(grid::nullGrob()),

wrap_elements(grid::nullGrob()),
wrap_elements(grid::nullGrob()),
results_proteomic_ALS_occurrence$sensi_1$plot_adjusted_gam_sensi_1$proteomic_metabolism_CD164, 
wrap_elements(grid::nullGrob())), 
...
## Sensitivity 3: stratifiyng the analysis in tertiles of follow-up duration

Data not shown because of merging sensi 1 and sensi 3
...
results_proteomic_ALS_occurrence$main$proteomic_sd_ALS_base_figure + labs(title = "Main analysis - full sample size") + theme(legend.position = "none") +
  results_proteomic_ALS_occurrence$sensi_3$proteomic_sd_ALS_base_figure_sensi_3_T1 + labs(title = "Filtered to follow-up T1 (<11 years)") + theme(legend.position = "none") +
  results_proteomic_ALS_occurrence$sensi_3$proteomic_sd_ALS_base_figure_sensi_3_T2 + labs(title = "Filtered to follow-up T2 (11-16 years)") + theme(legend.position = "none") +
  results_proteomic_ALS_occurrence$sensi_3$proteomic_sd_ALS_base_figure_sensi_3_T3 + labs(title = "Filtered to follow-up T3 (>16 years)") + theme(legend.position = "bottom") 
...
results_proteomic_ALS_occurrence$main$proteomic_sd_ALS_adjusted_figure + labs(title = "Main analysis - full sample size") + theme(legend.position = "none") +
  results_proteomic_ALS_occurrence$sensi_3$proteomic_sd_ALS_adjusted_figure_sensi_3_T1 + labs(title = "Filtered to follow-up T1 (<11 years)") + theme(legend.position = "none") +
  results_proteomic_ALS_occurrence$sensi_3$proteomic_sd_ALS_adjusted_figure_sensi_3_T2 + labs(title = "Filtered to follow-up T2 (11-16 years)") + theme(legend.position = "none") +
  results_proteomic_ALS_occurrence$sensi_3$proteomic_sd_ALS_adjusted_figure_sensi_3_T3 + labs(title = "Filtered to follow-up T3 (>16 years)") + theme(legend.position = "bottom") 
```

## Sensitivity 1 + 3: Removing NEFL outlier + stratifiyng the analysis in tertiles of follow-up duration

```{r}
#| echo: false
#| message: false
#| warning: false
results_proteomic_ALS_occurrence$sensi_3$sensi_3_table_follow_up
results_proteomic_ALS_occurrence$sensi_3$sensi_3_densityplot_follow_up
```
...
results_proteomic_ALS_occurrence$sensi_1_3$proteomic_sd_ALS_base_figure_sensi_1_3_T1 + labs(title = "Filtered to follow-up T1 (<11 years)\n+ NEFL outlier excluded \n Base model") + theme(legend.position = "none") +
results_proteomic_ALS_occurrence$sensi_1_3$proteomic_sd_ALS_base_figure_sensi_1_3_T2 + labs(title = "Filtered to follow-up T2 (11-16 years)\n+ NEFL outlier excluded \n Base model") + theme(legend.position = "none") +
results_proteomic_ALS_occurrence$sensi_1_3$proteomic_sd_ALS_base_figure_sensi_1_3_T3 + labs(title = "Filtered to follow-up T3 (>16 years)\n+ NEFL outlier excluded \n Base model") + theme(legend.position = "bottom")  
...
results_proteomic_ALS_occurrence$sensi_1_3$proteomic_sd_ALS_adjusted_figure_sensi_1_3_T1 + labs(title = "Filtered to follow-up T1 (<11 years)\n+ NEFL outlier excluded \n Adjusted model") + theme(legend.position = "none") +
results_proteomic_ALS_occurrence$sensi_1_3$proteomic_sd_ALS_adjusted_figure_sensi_1_3_T2 + labs(title = "Filtered to follow-up T2 (11-16 years)\n+ NEFL outlier excluded \n Adjusted model") + theme(legend.position = "none") +
results_proteomic_ALS_occurrence$sensi_1_3$proteomic_sd_ALS_adjusted_figure_sensi_1_3_T3 + labs(title = "Filtered to follow-up T3 (>16 years)\n+ NEFL outlier excluded \n Adjusted model") + theme(legend.position = "bottom")  
```
...
The Fasano–Franceschini test is a multivariate extension of the Kolmogorov–Smirnov test.
While the classical KS test only compares one-dimensional distributions, the Fasano–Franceschini test can compare two-dimensional or multidimensional distributions.
...
H₀: The two datasets come from the same multivariate distribution.
...
#| message: false
#| warning: false
results_proteomic_ALS_occurrence$additional_analysis_3$additional_analysis_3_figure
results_proteomic_ALS_occurrence$additional_analysis_3$additional_analysis_3_results
```
...
#| message: false
#| warning: false
wrap_plots(results_proteomic_ALS_survival$plot_base_gam, ncol = 3)
# wrap_plots(results_proteomic_ALS_survival$plot_adjusted_gam, ncol = 3)
```
