...
results adjusted on the cohort (4 categories)
```{r}
#| echo: false
#| message: false
#| warning: false
...
results adjusted on the cohort (2 categories danish or finnish)
```{r}
#| echo: false
#| message: false
#| warning: false
...
effects of baseline age, follow-up duration among the Finnish population (stratified and adjusted analyses)
```{r, fig.width=10}
#| echo: false
#| message: false
#| warning: false
...
effects of baseline age, follow-up duration among the Finnish population (interaction anayses)
```{r}
#| echo: false
#| message: false
#| warning: false
results_POPs_ALS_survival$sensi3$POPs_sd_ALS_table_sensi3 |>
  set_table_properties(width = 1, layout = "autofit", align = "left")
```
