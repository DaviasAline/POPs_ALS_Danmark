...
#| warning: false
#| column: screen-inset-right
results_POPs_ALS_survival$danish$POPs_quart_ALS_table_finnish_raw |>
  set_table_properties(width = 1, layout = "autofit", align = "left")
```
...
#| message: false
#| warning: false
results_POPs_ALS_survival$danish$POPs_quart_ALS_figure_finnish_raw
```
...
#| message: false
#| warning: false
coef(results_POPs_ALS_survival$sensi6$sensi6_lasso_sd_danish, s = "lambda.1se")  
```
...
#| message: false
#| warning: false
coef(results_POPs_ALS_survival$sensi6$sensi6_elastic_net_sd_danish, s = "lambda.1se")
```
