...
## Main analysis - logistic regressions
...
results_proteomic_ALS_occurrence$main$proteomic_sd_ALS_table |>
  set_table_properties(width = 1, layout = "autofit", align = "left")
results_proteomic_ALS_occurrence$main$proteomic_sd_ALS_base_figure
...
#| message: false
#| warning: false
wrap_plots(results_proteomic_ALS_occurrence$sensi_1$plot_base_gam_sensi_1, ncol = 3)
```
...
#| message: false
#| warning: false
results_proteomic_ALS_occurrence$sensi_2$proteomic_sd_ALS_base_figure_sensi_2
```
...
#| message: false
#| warning: false
wrap_plots(results_proteomic_ALS_occurrence$sensi_2$plot_base_gam_sensi_2, ncol = 3)
```
...
#| message: false
#| warning: false
wrap_plots(results_proteomic_ALS_occurrence$sensi_1_2$plot_base_gam_sensi_1_2, ncol = 3)
```
...
```{r, fig.width=12}
results_proteomic_ALS_occurrence$main$proteomic_sd_ALS_base_figure + labs(title = "Main analysis - full sample size") + 
results_proteomic_ALS_occurrence$sensi_3$proteomic_sd_ALS_base_figure_sensi_3_T1 + labs(title = "Filtered to follow-up T1 (<11 years)") + 
results_proteomic_ALS_occurrence$sensi_3$proteomic_sd_ALS_base_figure_sensi_3_T2 + labs(title = "Filtered to follow-up T2 (11-16 years)") + 
results_proteomic_ALS_occurrence$sensi_3$proteomic_sd_ALS_base_figure_sensi_3_T3 + labs(title = "Filtered to follow-up T3 (>16 years)") 
```
...
We don't see many signals in the follow-up group T1: I suspect that it is because of high heterogeneity in follow-up duration among this sub-group (1-11 years).
