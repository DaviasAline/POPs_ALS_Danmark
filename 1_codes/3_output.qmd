...
results_proteomic_ALS_occurrence$proteomic_sd_ALS_table |>
  set_table_properties(width = 1, layout = "autofit", align = "left")
results_proteomic_ALS_occurrence$proteomic_sd_ALS_base_figure
...
#| message: false
#| warning: false
wrap_plots(results_proteomic_ALS_occurrence$plot_base_gam, ncol = 3)
# wrap_plots(results_proteomic_ALS_occurrence$plot_adjusted_gam, ncol = 3)
```
